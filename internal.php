...
<div id="menucase">
  <div id="styletwo">
    <ul>
      ...
      <li><a href="students.php" >STUDENTS&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</li>
  ...
  <a href="adminsection.php"><img src=img/goback1.png onmouseover="this.src='img/goback.png';" onmouseout="this.src='img/goback1.PNG';" height="40px" width="70px"> </a>
<a href="internalupdate.php"><input type="button" value="Update Result" style="cursor:pointer;float:right;border-radius:10px;color:yellow;background-color:black;padding:8px;"> </a>
  <div  id="content1"> 
...
if(mysql_query("insert internal values('$t1','$t2','$t3','$t4','$t5','$t6','$t7','$t8')"))
...
<h2>Insert Marks For Internal Exam and Assignment</h2>
