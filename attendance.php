...
<div id="menucase">
  ...
  <a href="adminsection.php"><img src=img/goback1.png onmouseover="this.src='img/goback.png';" onmouseout="this.src='img/goback1.PNG';" height="40px" width="70px" align="left"> </a>
<a href="attendanceupdate.php"><input type="button" value="Update Attendance" style="cursor:pointer;float:right;border-radius:10px;color:yellow;background-color:black;padding:8px;"></a>
  <div  id="content1"> 
<div class="login">
<?php
...
mysql_query("insert attendance values('$a1','$a3','$t1','$t2','$t3')");
echo "inserted";
}
else
{
...
<h2>Insert attendance details</h2>
<table>
